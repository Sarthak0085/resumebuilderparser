...
import { groupTextItemsIntoLines } from '../lib/parse-resume-from-pdf/groupTextItemsIntoLines';
import { groupLinesIntoSection } from '../lib/parse-resume-from-pdf/groupLinesIntoSection';
import { extractResumeFromSections } from '../lib/parse-resume-from-pdf/extract-resume-from-section';
import readPdf from '../lib/parse-resume-from-pdf/readPdf';
...
const RESUME_EXAMPLES = [
  ...
  },
  {
    ...
    description: (
      <span>
        Created with Inhouse Resume Builder - <Link href="/resume-builder">Link</Link>
      </span>
    ),
  },
];
      ...
      <div className="grid md:grid-cols-6">
        ...
        <div className="flex px-6 text-gray-900 md:col-span-3 md-h-[calc(100vh-var(--top-nav-bar-height))] md:overflow-y-scroll">
          ...
          <section className="max-w-[600px] grow">
            <Heading className="text-primary !mt-4">Resume Parser Playground</Heading>
            <Paragraph smallMarginTop={true}>
              This playground showcases the Inhouse resume parser and its ability to parse
              information from a resume PDF. Click around the PDF examples below to observe
            ...
            <Paragraph>
              You can also <span className="font-semibold">add your resume below</span> to access
              how well your resume would be parsed by similar Application Tracking System (ATS) used
              in job applications. The more information it can parse out, the better it indicates
